...
import io.github.manasjain0405.employeemanagement.service.impl.KafkaProducerServiceI;
...
public class EmployeeController {
    ...
    @Autowired
    private KafkaProducerServiceI producerService;
    ...
    public void addEmployee(@RequestBody final Employee employee) {
        producerService.sendToAddQueue(employee); //Kafka
        //template.convertAndSend(constants.EMPLOYEE_EXCHANGE, constants.ADD_EMPLOYEE_ROUTING_KEY, employee); //RabbitMQ
    }
    ...
    public void modifyEmployee(@PathVariable("id") final Long employeeId, @RequestBody final Employee employee) {
        ...
        template.convertAndSend(constants.EMPLOYEE_EXCHANGE, constants.MODIFY_EMPLOYEE_ROUTING_KEY, employee); //RabbitMQ
    }
